...
namespace FF1Lib
{
	...
	public static class TeleportLocations
	{
		...
		public static OWTeleportLocation ConeriaCastle = new OWTeleportLocation(OverworldTeleportIndex.ConeriaCastle1, 153, 159, TeleportShuffle.ConeriaCastle1F);
		...
		public static OWTeleportLocation CastleOrdeals = new OWTeleportLocation(OverworldTeleportIndex.CastleOrdeals1, 130, 45, TeleportShuffle.CastleOrdeals1F);
		...
		public static OWTeleportLocation EarthCave = new OWTeleportLocation(OverworldTeleportIndex.EarthCave1, 65, 187, TeleportShuffle.EarthCaveB1);
		public static OWTeleportLocation GurguVolcano = new OWTeleportLocation(OverworldTeleportIndex.GurguVolcano1, 188, 205, TeleportShuffle.GurguVolcanoB1);
		public static OWTeleportLocation IceCave = new OWTeleportLocation(OverworldTeleportIndex.IceCave1, 197, 183, TeleportShuffle.IceCaveB1A);
		...
		public static OWTeleportLocation MarshCave = new OWTeleportLocation(OverworldTeleportIndex.MarshCave1, 102, 236, TeleportShuffle.MarshCaveB1);
		public static OWTeleportLocation MirageTower = new OWTeleportLocation(OverworldTeleportIndex.MirageTower1, 194, 59, TeleportShuffle.MirageTower1F);
