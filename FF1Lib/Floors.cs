...
namespace FF1Lib
{
	public partial class FF1Rom : NesRom
	{
		...
		public void ShuffleFloors(MT19337 rng)
		{
			...
			var ConeriaTown = Floor.Create(MapLocation.Coneria, MapIndex.ConeriaTown, Tileset.Town, 16, 23);
			var Pravoka = Floor.Create(MapLocation.Pravoka, MapIndex.Pravoka, Tileset.Town, 19, 32);
			var ElflandTown = Floor.Create(MapLocation.Elfland, MapIndex.Elfland, Tileset.Town, 41, 22);
			var Melmond = Floor.Create(MapLocation.Melmond, MapIndex.Melmond, Tileset.Town, 1, 16);
			var CresentLake = Floor.Create(MapLocation.CrescentLake, MapIndex.CrescentLake, Tileset.Town, 11, 23);
			...
			var ConeriaCastle = Floor.Create(MapLocation.ConeriaCastle1, MapIndex.ConeriaCastle1F, Tileset.Castle, 12, 35, OverworldExit.ExitCastleConeria);
			...
			var BahamutCaveB1 = Floor.Create(MapLocation.BahamutCave1, MapIndex.BahamutCaveB1, Tileset.IceCardiaWaterfall, 2, 2, Teleporter.BahamutsRoom);
			var BahamutCaveB2 = Floor.Create(MapLocation.BahamutCave1, MapIndex.BahamutCaveB2, Tileset.IceCardiaWaterfall, 23, 45);
			...
			var IceCaveB1 = Floor.Create(MapLocation.IceCave1, MapIndex.IceCaveB1, Tileset.IceCardiaWaterfall, 7, 1, Teleporter.IceCave1);
			var IceCaveB2 = Floor.Create(MapLocation.IceCave1, MapIndex.IceCaveB2, Tileset.IceCardiaWaterfall, 30, 2, Teleporter.IceCave2);
			var IceCaveB3 = Floor.Create(MapLocation.IceCave1, MapIndex.IceCaveB3, Tileset.IceCardiaWaterfall, 3, 2, Teleporter.IceCave3);
			var IceCaveB4 = Floor.Create(MapLocation.IceCave1, MapIndex.IceCaveB2, Tileset.IceCardiaWaterfall, 55, 5, OverworldExit.ExitIceCave); // Everything after the stairs before the FLOATER room.
			...
			var EarthCaveB1 = Floor.Create(MapLocation.EarthCave1, MapIndex.EarthCaveB1, Tileset.EarthFireTitans, 23, 24, Teleporter.EarthCave1);
			var EarthCaveB2 = Floor.Create(MapLocation.EarthCave1, MapIndex.EarthCaveB2, Tileset.EarthFireTitans, 10, 9, Teleporter.EarthCave2);
			var EarthCaveB3 = Floor.Create(MapLocation.EarthCave1, MapIndex.EarthCaveB3, Tileset.EarthFireTitans, 27, 45, Teleporter.EarthCave3, AccessRequirement.Rod);
			var EarthCaveB4 = Floor.Create(MapLocation.EarthCave1, MapIndex.EarthCaveB4, Tileset.EarthFireTitans, 61, 33, Teleporter.EarthCave4);
			var EarthCaveB5 = Floor.Create(MapLocation.EarthCave1, MapIndex.EarthCaveB5, Tileset.EarthFireTitans, 25, 53, OverworldExit.ExitEarthCave);

			var GurguVolcanoB1 = Floor.Create(MapLocation.GurguVolcano1, MapIndex.GurguVolcanoB1, Tileset.EarthFireTitans, 27, 15, Teleporter.Gurgu1);
			var GurguVolcanoB2 = Floor.Create(MapLocation.GurguVolcano1, MapIndex.GurguVolcanoB2, Tileset.EarthFireTitans, 30, 32, Teleporter.Gurgu2);
			var GurguVolcanoB3A = Floor.Create(MapLocation.GurguVolcano1, MapIndex.GurguVolcanoB3, Tileset.EarthFireTitans, 18, 2, Teleporter.Gurgu3);
			var GurguVolcanoB4A = Floor.Create(MapLocation.GurguVolcano1, MapIndex.GurguVolcanoB4, Tileset.EarthFireTitans, 3, 23, Teleporter.Gurgu4);
			var GurguVolcanoB3B = Floor.Create(MapLocation.GurguVolcano1, MapIndex.GurguVolcanoB3, Tileset.EarthFireTitans, 46, 23, Teleporter.Gurgu5);
			var GurguVolcanoB4B = Floor.Create(MapLocation.GurguVolcano1, MapIndex.GurguVolcanoB4, Tileset.EarthFireTitans, 35, 6, Teleporter.Gurgu6);
			var GurguVolcanoB5 = Floor.Create(MapLocation.GurguVolcano1, MapIndex.GurguVolcanoB5, Tileset.EarthFireTitans, 32, 31, OverworldExit.ExitGurguVolcano);

			// Mirage / Marsh
			var MarshCaveB1 = Floor.Create(MapLocation.MarshCave1, MapIndex.MarshCaveB1, Tileset.MirageMarsh, 21, 27, Teleporter.MarshCave1, Teleporter.MarshCave3); // Top floor + large empty second floor
			var MarshCaveB2 = Floor.Create(MapLocation.MarshCave1, MapIndex.MarshCaveB2, Tileset.MirageMarsh, 18, 16);
			var MarshCaveB3 = Floor.Create(MapLocation.MarshCave1, MapIndex.MarshCaveB3, Tileset.MirageMarsh, 5, 6);

			var MirageTower1F = Floor.Create(MapLocation.MirageTower1, MapIndex.MirageTower1F, Tileset.MirageMarsh, 17, 31, Teleporter.MirageTower1);
			var MirageTower2F = Floor.Create(MapLocation.MirageTower1, MapIndex.MirageTower2F, Tileset.MirageMarsh, 16, 31, Teleporter.MirageTower2);
			var MirageTower3F = Floor.Create(MapLocation.MirageTower1, MapIndex.MirageTower3F, Tileset.MirageMarsh, 8, 1, Teleporter.SkyPalace2, AccessRequirement.Cube); // Includes SkyPalace1F due to in room like Marsh
			...
			// Sky Palace
			var SkyPalace2F = Floor.Create(MapLocation.MirageTower1, MapIndex.SkyPalace2F, Tileset.SkyPalace, 19, 4, Teleporter.SkyPalace3);
			var SkyPalace3F = Floor.Create(MapLocation.MirageTower1, MapIndex.SkyPalace3F, Tileset.SkyPalace, 24, 23, Teleporter.SkyPalace4);
			var SkyPalace4F = Floor.Create(MapLocation.MirageTower1, MapIndex.SkyPalace4F, Tileset.SkyPalace, 3, 3, Teleporter.SkyPalace5);
			var SkyPalace5F = Floor.Create(MapLocation.MirageTower1, MapIndex.SkyPalace5F, Tileset.SkyPalace, 7, 54, OverworldExit.ExitSkyPalace);
